...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_syo_maukkaasti__ei_vie_saldoa_negatiiviseksi(self):
    ...
    def test_syo_edullisesti_onnistuu_hinnan_saldolla(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()
        self.assertEqual(str(kortti), "Kortilla on rahaa 0.00 euroa")

    def test_syo_maukkaasti__onnistuu_hinnan_saldolla(self):
